...
from quotecast.pb.quotecast_pb2 import Quotecast, NewTicker
from typing import Dict
from wrapt.decorators import synchronized

class NewQuotecastParser:
    ...
    def build_ticker_from_quotecast(
        ...
        for data in parsed_json:
            ...
            or  data['m'] == 'us':
                ...
                del references[data['v'][0]]
            else:
                raise AttributeError('Unknown')

        # SETUP PRODUCT LIST
        ticker.product_list.extend(ticker.products._values.keys())
