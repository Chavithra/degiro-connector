...
product_id = 1234567
id = 1234567
success = trading_api.delete_favourite_list_product(id=id, product_id=product_id)

# DISPLAY - MESSAGE
if success:
    print(f"The following product was deleted : {product_id} => {id}")
else:
    print(f"Can't delete the following product : {product_id} => {id}")
