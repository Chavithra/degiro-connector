...
class Order(google.protobuf.message.Message):
    ...
    class ConfirmationResponse(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"response_datetime",b"response_datetime"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"orderId",b"orderId",u"response_datetime",b"response_datetime"]) -> None: ...
...
class ProductSearch(google.protobuf.message.Message):
    ...
    class RequestStocks(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[u"index_id",b"index_id",u"is_in_us_green_list",b"is_in_us_green_list",u"limit",b"limit",u"offset",b"offset",u"require_total",b"require_total",u"search_text",b"search_text",u"sort_columns",b"sort_columns",u"sort_types",b"sort_types",u"stock_country_id",b"stock_country_id"]) -> None: ...
