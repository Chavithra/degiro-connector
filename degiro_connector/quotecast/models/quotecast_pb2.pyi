...
class Chart(google.protobuf.message.Message):
    ...
    class Request(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal[u"culture",b"culture",u"period",b"period",u"requestid",b"requestid",u"resolution",b"resolution",u"series",b"series",u"tz",b"tz"]) -> None: ...
    ...
    @property
    def series(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.protobuf.struct_pb2.Struct]: ...
    def __init__(self,
        *,
        requestid : typing.Text = ...,
        start : typing.Text = ...,
        ...
        resolution : typing.Text = ...,
        series : typing.Optional[typing.Iterable[google.protobuf.struct_pb2.Struct]] = ...,
        ) -> None: ...
